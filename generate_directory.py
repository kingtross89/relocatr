...
<body class="page-plan-active">
  ...
  <nav id="navbar" style="background: rgba(8,11,20,0.95)">
    <div class="nav-inner">
      ...
      <div class="page-nav">
        <a href="index.html" class="page-nav-btn" style="text-decoration:none; display:flex; align-items:center; background: rgba(99,102,241,0.15); border: 1px solid var(--accent); color: var(--text); padding: 8px 16px; border-radius: var(--radius-sm); font-weight:600; font-family:'Outfit', sans-serif; font-size:0.9rem;">🗺️ Back to Planner</a>
      </div>
    </div>
  </nav>
